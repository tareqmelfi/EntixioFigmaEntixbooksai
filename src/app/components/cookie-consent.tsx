...
export function CookieConsent() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[90] pointer-events-none px-3 pb-3 sm:px-6 sm:pb-5" dir={isAr ? "rtl" : "ltr"}>
      <div className="pointer-events-auto mx-auto max-w-3xl bg-white border border-gray-200 rounded-2xl shadow-2xl shadow-[#0B1B49]/15 overflow-hidden">
        <div className="p-5 sm:p-6">
          <div className="flex items-start gap-3.5">
            <span className="w-10 h-10 rounded-xl bg-[#EFF6FF] flex items-center justify-center shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-2.5 mt-5">
            <button
              ...
              className="bg-primary hover:bg-primary/90 text-white px-6 py-2.5 rounded-xl transition-all cursor-pointer shadow-lg shadow-[#1276E3]/20"
...
function PreferenceRow({ icon, title, desc, on, locked, onToggle }: {
  ...
  return (
    <div className="flex items-center gap-3 bg-gray-50 rounded-xl px-3.5 py-3">
      ...
      {locked ? (
        <span className="text-[#166534] bg-[#DCFCE7] rounded-full px-2.5 py-1 shrink-0" style={{ fontSize: "11px", fontWeight: 700 }}>
          {t("دائمًا", "Always on")}
        </span>
      ) : (
        <button
