  ...
  return (
    <div className={`relative ${className}`}>
      <input
        ...
        disabled={disabled}
        required={required}
        className={`w-full ${inputClassName || "h-10 text-sm"} rounded-md border ${invalid ? "border-danger ring-1 ring-danger-border" : "border-border"} bg-card px-3 pe-9 font-english text-start focus:outline-none focus:ring-2 focus:ring-ring/25 disabled:opacity-50`}
