...
export function Receipts() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm("هل تريد حذف سند القبض؟ سيتم تعديل رصيد الفاتورة المرتبطة.")) return;
    try {
    ...
    <div className="space-y-6">
      ...
      <Dialog open={open} onOpenChange={(o) => { setOpen(o); if (!o) { setError(null); resetForm(); } }}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader><DialogTitle className="text-[#0B1B49]">سند قبض جديد</DialogTitle></DialogHeader>
