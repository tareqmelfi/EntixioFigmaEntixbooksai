...
export function AdminDashboard({ section = "overview" }: { section?: AdminSection }) {
  ...
  return (
    <div className={`space-y-5 ${section === "overview" ? "max-w-none" : "max-w-7xl"}`}>
