...
const FAQS: Array<{ qAr: string; qEn: string; aAr: string; aEn: string }> = [
  ...
  { qAr: "هل أنتم متوافقون مع ZATCA؟", qEn: "Are you ZATCA-compliant?",
    aAr: "النظام جاهز للفوترة الإلكترونية (المرحلة الثانية) — XML + QR بالمواصفات، والتفعيل يتم عبر CSID من بوابة فاتورة عند ربطك. نكتب «جاهز» لا «متوافق بالكامل» لأن الاعتماد يتم عند ربط منشأتك فعليًا.",
    aEn: "The system is Phase-2 e-invoicing ready — spec XML + QR, activated via your CSID from the Fatoora portal when you connect. We say “ready”, not “fully compliant”, because compliance happens when your entity is actually onboarded." },
