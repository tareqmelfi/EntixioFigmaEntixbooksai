...
const arSections = [
  ...
  {
    icon: Smartphone,
    title: "2. الوصول إلى الكاميرا والصور والملفات في iOS",
  ...
  {
    icon: FileText,
    title: "4. الذكاء الاصطناعي وOCR ومعالجو الخدمة",
  ...
  {
    icon: Lock,
    title: "5. الأمان والمشاركة والاحتفاظ",
  ...
  {
    icon: UserX,
    title: "6. الحذف والاسترداد وحقوقك",
  ...
  {
    icon: BadgeCheck,
    title: "7. لا بيع ولا تتبع عبر التطبيقات",
