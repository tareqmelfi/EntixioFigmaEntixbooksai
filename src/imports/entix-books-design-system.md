...
### Screen 3: Sales Invoices — فواتير المبيعات
```
...
### Screen 4: Create Invoice — إنشاء فاتورة جديدة
```
...
### Screen 5: Contacts — جهات الاتصال
```
...
### Screen 6: Chart of Accounts — دليل الحسابات
```
...
### Screen 7: Journal Entries — قيود اليومية
```
List view:
...
### Screen 8: Reports — التقارير (COMPREHENSIVE)
```
...
### Screen 10: Purchase Bills — فواتير المشتريات
```
Mirror layout of Sales Invoices (Screen 3)
Replace: عميل → مورد, مبيعات → مشتريات
Summary: مشتريات الشهر + الفواتير غير المدفوعة
```

### Screen 11: Quotations — عروض الأسعار
```
...
│   ├── 01-Login (3 variants)
│   ├── 02-Dashboard
│   ├── 03-Invoice-List (3 variants)
│   ├── 04-Invoice-Create (3 variants)
│   ├── 05-Contacts (3 variants)
│   ├── 06-Chart-of-Accounts
│   ├── 07-Journal-Entries (list + create)
│   ├── 08-Reports (comprehensive, 42 reports)
│   ├── 09-Settings (5 tabs)
│   ├── 10-Purchase-Bills
│   └── 11-Quotations
└── 📐 Layout Templates
