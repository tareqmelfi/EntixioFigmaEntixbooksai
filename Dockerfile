...
server {
  ...
  # /q = public quote-accept links (SPEC-04) · /b = public branded boards (SPEC-06)
  location ~ ^/(?:app|admin|portal|print|invite|verify-email|welcome|buy|claim|q|b)(?:/|$) { try_files $uri /app-shell.html; }
