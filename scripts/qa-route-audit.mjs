...
const allRoutes = [
  group("Public website", [
    ...
    route("/privacy", "Privacy policy covers web and iOS data handling."),
    route("/support/ios", "Substantive bilingual iOS support, privacy, permissions, and deletion guidance renders."),
